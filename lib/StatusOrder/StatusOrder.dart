...
import 'package:petsecom/StatusOrder/constant.dart';
import 'package:status_change/status_change.dart';

class StatuOrder extends StatefulWidget {
  const StatuOrder({super.key});

  @override
  State<StatuOrder> createState() => _StatuOrderState();
}

class _StatuOrderState extends State<StatuOrder> {
  int _processIndex = 0;
